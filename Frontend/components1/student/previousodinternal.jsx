...
const renderImageWithLocation = async (uri, latitude, longitude,id,email,todayDateString,startDateString,endDateString) => {
    ...
    const path = 'geotag_photos';
        ...
        await axios.post(`${api}/saveImageUrl`, { imageUrl: uploadedImageUrl,id:id,email:email });
    ...
    const categories = [
        ...
        { key: 'inProgressJioTaginternal', label: 'In-progress (JioTag)' },
                    ...
                    {filteredResults.length > 0 ? filteredResults.map((item) => (
                        <View key={item.id} style={styles.card}>
                            ...
                            <View style={styles.actionButtons}>
                                ...
                                {selectedCategory === "inProgressJioTaginternal" && (
                                    <TouchableOpacity 
